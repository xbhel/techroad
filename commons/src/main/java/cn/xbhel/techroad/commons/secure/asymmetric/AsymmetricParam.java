...
public class AsymmetricParam {
    ...
    protected AsymmetricParam(String algorithm, PublicKey publicKey, PrivateKey privateKey) {
    ...
    public static AsymmetricParam of(AsymmetricAlgorithm algorithm) {
        return of(algorithm.getName(), algorithm.getKeySize());
    }

    public static AsymmetricParam of(String algorithm, int keySize) {
        var keyPair = KeyUtils.getKeyPair(algorithm, keySize);
        return of(algorithm, keyPair.getPublic(), keyPair.getPrivate());
    }

    public static AsymmetricParam of(String algorithm, PublicKey publicKey, PrivateKey privateKey) {
        return new AsymmetricParam(algorithm, publicKey, privateKey);
    }
}
